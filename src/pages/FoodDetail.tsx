...
const FoodDetails = () => {
  const { restaurantId, donationId } = useParams(); // Ensure restaurantId and donationId are extracted from URL params
  ...
  if (!food) return <p className="text-gray-500">Food details not found or loading...</p>;
