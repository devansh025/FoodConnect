...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden mt-4 bg-white dark:bg-gray-900 shadow-md rounded-lg px-4 py-3 space-y-3">
          {navLinks.map((link) => (
            <Link
              key={link.path}
              to={link.path}
              ...
              className={cn(
                ...
                location.pathname === link.path
                  ...
                  : "text-gray-800 dark:text-gray-200 hover:text-connect-green-500"
              )}
            >
              {link.name}
            </Link>
          ...
          {userType && (
            <Link
              to={userType === "ngo" ? "/ngo/dashboard" : "/restaurant/dashboard"}
              onClick={() => setIsMobileMenuOpen(false)}
              className="block text-sm font-medium text-gray-800 dark:text-gray-200 hover:text-connect-green-500"
            >
              Dashboard
            </Link>
          )}
          ...
          {user ? (
            <Button
              ...
              className="w-full text-sm bg-connect-green-500 text-white hover:bg-connect-green-600"
            >
              Logout
            </Button>
          ) : (
            <>
              ...
              <Button asChild className="w-full text-sm bg-connect-green-500 hover:bg-connect-green-600">
